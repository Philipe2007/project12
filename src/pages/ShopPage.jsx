...
//                 className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#E0218A] px-5 py-3 font-semibold text-white transition hover:bg-[#E0218A]"
//               >
//                 Proceed to order
//                 <ArrowRight size={18} />
//               </button>
...
//             }}
//             className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#E0218A] px-6 py-3 font-semibold text-white hover:bg-[#E0218A]"
//           >
