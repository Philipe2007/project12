...
const salonImages = {
  ...
  root_12: root_12,
  texture1: texture1,
  color_package12: color_package12,
  aaa: aaa,
  eyeblow: eyeblow,
  faciar: faciar,
  scalp: scalp,
...
export const products = [
  ...
  // },
  {
    ...
    name: 'Color Package',
    slug: 'color-package',
    category: 'Color Packages',
    description: 'A complete color refresh package for tone, vibrancy and an even, polished finish.',
    image: salonImages.rootTouchUp,
    price: 180,
    stock: 4,
    active: true,
  },
  {
    id: 'root-color-package',
    name: 'Root Color Package',
    slug: 'root-color-package',
    category: 'Root Color Packages',
    description: 'Perfect for low-maintenance root coverage and seamless blending close to the scalp.',
    image: salonImages.color_package12,
    price: 16000,
    stock: 5,
    active: true,
  },
  {
    ...
    slug: 'texture-package',
    category: 'Texture Packages',
    description: 'A nourishing texture treatment package designed for definition, softness and shine.',
    image: salonImages.naturalHair,
    price: 22000,
    stock: 3,
    active: true,
  },
  {
    ...
    slug: 'treatments',
    category: 'Treatments',
    description: 'Add a deep-conditioning or repair treatment to restore moisture and smoothness.',
    image: salonImages.deep_condtion,
    price: 4500,
    stock: 12,
    active: true,
  },
  {
    id: 'styling-upgrade-addon',
    name: 'Styling upgrades',
    slug: 'styling-upgrades',
    category: 'Styling upgrades',
    description: 'Upgrade your style with a smoother finish, extra shaping or longer-lasting hold.',
    image: salonImages.silkPress,
    price: 3000,
    stock: 14,
    active: true,
  },
  {
    id: 'additional-color-addon',
    name: 'Additional color',
    slug: 'additional-color',
    category: 'Additional color',
    description: 'Add extra color work for dimension, brighter tone balance or touch-up coverage.',
    image: salonImages.balayage,
    price: 6000,
    stock: 8,
    active: true,
  },
